...
inline constexpr std::string_view COUNT_ANY =
    "SELECT COUNT(*) FROM user WHERE deleted_at IS NULL";

inline constexpr std::string_view COUNT_OTHER_ACTIVE_OWNERS =
    "SELECT COUNT(*) FROM user WHERE role = 'owner' AND is_active = 1 "
