...
// Native handler of the camera:* and voice:* frames: StreamHub video
// subscriptions and one voice session per connection. Installed only by the
// backend; the gateway relays those frames to the legacy instead.
